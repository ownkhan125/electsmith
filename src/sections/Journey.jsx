...
const MILESTONES = [
  {
    ...
    body:
      "Served four years as an electronics technician, deploying twice across the Pacific.",
  },
  {
    year: "2006",
    title: "First class at Bridge High",
    body:
      "Came home, used the GI Bill, and started teaching physics. 1,100 students later, and I still keep their letters.",
  },
  {
    year: "2014",
    title: "Elected to the school board",
    body:
      "Led the fund-balanced budget that brought back music, art, and shop class to every middle school in the district.",
  },
  {
    year: "2019",
    title: "Founded the River Coalition",
    body:
      "Built a bipartisan partnership protecting 60 miles of the Columbia tributaries from industrial discharge.",
  },
  {
    year: "2023",
    title: "Joined the State Workforce Council",
    body:
      "Helped expand apprenticeships in clean energy — the program is now training 2,300 Oregonians a year.",
  },
  {
    year: "2026",
    title: "Running for U.S. Congress",
    body:
      "Filed Day 1. Refused every corporate dollar. Showed up to 31 town halls before lunch on launch week.",
  },
];
      ...
      <div ref={scope}>
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            >
              You don’t get to call yourself a public servant on Day 1. You
              have to earn it — on school boards, in town halls, on the river,
              in the wind. Here’s the trail.
            </p>
          </div>
