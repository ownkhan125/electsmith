      ...
      <SectionFrame id="story" eyebrow="The story">
        <div className="grid grid-cols-1 gap-14 md:grid-cols-12 md:gap-12">
          <div className="md:col-span-5">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, transparent 40%, rgba(40,15,55,0.45) 100%)",
                }}
              />
          ...
          <div className="md:col-span-7">
            ...
            >
              <p>
                I grew up in Hood River. My mom taught third grade and my dad
                fixed radiators in a shop he opened with a $4,000 SBA loan. We
                weren’t wealthy, but we had public school, public libraries,
                and a public health clinic that kept us going when things got
                hard.
              </p>
              <p>
                After high school I enlisted in the U.S. Navy. Four years and
                two Pacific deployments later I came home, used the GI Bill,
                and started teaching physics. Twelve years and 1,100 students
                later, I still keep their letters in a shoebox under my desk.
              </p>
              <p>
                I’m running because too many of those guardrails are crumbling
                while Washington bickers. I want to be the kind of
                representative who returns phone calls, files real bills, and
                shows up when the bridge to your neighborhood is closing.
              </p>
            </div>
